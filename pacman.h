...
///MACRO SOLO DI PACMAN///

    // Valori interi che rappresentano le frecce della tastiera
    #define FRECCIA_SU 65
    #define FRECCIA_DESTRA 67
    #define FRECCIA_GIU 66
    #define FRECCIA_SINISTRA 68
